...
router.get('/public/images/kanye-stare.gif', function(req, res, next) {
  res.sendFile('/home/iky/Documents/java-script/kayne/public/images/kanye-stare.gif');
});

router.get('/public/images/kayne-microphone.jpeg', function(req, res, next) {
  res.sendFile('/home/iky/Documents/java-script/kayne/public/images/kayne-microphone.jpeg');
});
/* IMAGES */
...
router.get('/public/audio/look-at-this-dude.mp3', function(req, res, next) {
  res.sendFile('/home/iky/Documents/java-script/kayne/public/audio/look-at-this-dude.mp3');
});

router.get('/public/audio/mission-failed.mp3', function(req, res, next) {
  res.sendFile('/home/iky/Documents/java-script/kayne/public/audio/mission-failed.mp3');
});
/* AUDIO */
